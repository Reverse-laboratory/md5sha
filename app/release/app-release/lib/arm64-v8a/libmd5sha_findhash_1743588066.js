...
function hook_suspected_function(targetSo) {
    const funcs = [['sub_3B2C0', '函数sub_3B2C0疑似哈希函数，包含初始化魔数的代码。', '0x3b2c0'], ['sub_3B48C', '函数sub_3B48C疑似哈希函数，包含初始化魔数的代码。', '0x3b48c']];
    for (var i in funcs) {
...
function main() {
    var targetSo = Module.findBaseAddress('libmd5sha.so');
